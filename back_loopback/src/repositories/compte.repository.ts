...
> {
  ...
  public readonly banque: BelongsToAccessor<Banque, typeof Compte.prototype.IDcompte>;

  constructor(
    @inject('datasources.mccb_mysql') dataSource: MccbMysqlDataSource, @repository.getter('BanqueRepository') protected banqueRepositoryGetter: Getter<BanqueRepository>,
  ) {
    super(Compte, dataSource);
    this.banque = this.createBelongsToAccessorFor('banque', banqueRepositoryGetter,);
